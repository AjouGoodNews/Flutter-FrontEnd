...
const Color lightPrimary = Color(0xFFDBFFF2);

/// Gray scale
const Color black = Color(0xFF323232);
const Color darkGray = Color(0xFF787878);
const Color gray = Color(0xFF9F9F9F);
const Color semiGray = Color(0xFFE9E9E9);
